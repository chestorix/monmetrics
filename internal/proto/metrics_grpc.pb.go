...
const (
	MetricsService_UpdateMetric_FullMethodName       = "/monmetrics.MetricsService/UpdateMetric"
	MetricsService_UpdateMetricsBatch_FullMethodName = "/monmetrics.MetricsService/UpdateMetricsBatch"
	MetricsService_GetMetric_FullMethodName          = "/monmetrics.MetricsService/GetMetric"
	MetricsService_Ping_FullMethodName               = "/monmetrics.MetricsService/Ping"
)
...
func (c *metricsServiceClient) UpdateMetricsBatch(ctx context.Context, in *UpdateMetricsBatchRequest, opts ...grpc.CallOption) (*UpdateMetricsBatchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMetricsServiceServer) UpdateMetricsBatch(context.Context, *UpdateMetricsBatchRequest) (*UpdateMetricsBatchResponse, error) {
...
func _MetricsService_UpdateMetricsBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServiceServer).UpdateMetricsBatch(ctx, req.(*UpdateMetricsBatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MetricsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "monmetrics.MetricsService",
